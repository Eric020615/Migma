...
import com.example.migma.entity.TransactionModel;
...
public class TopUpFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference transactionReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://migma-2f57a-default-rtdb.firebaseio.com/");
